<template>
  <div class="app-container department-container">
    ...
    <div v-if="changeLog.open" class="local-modal-mask" style="z-index: 2100;">
      <div class="local-modal-content" style="width: 720px; min-width: 400px; min-height: auto; max-width: 92vw !important;">
...
import { listdepart, departTree, getdepart, deldepart, adddepart, updatedepart, updateReferred, validateDepartImport, importDepartData, listDepartmentChangeLog } from "@/api/foundation/depart";
...
export default {
  ...
  methods: {
    ...
    handleUpdateReferred() {
      ...
      this.$modal.confirm("是否为选中的科室按名称更新简码？").then(() => {
        return updateReferred(this.ids);
      }).then(() => {

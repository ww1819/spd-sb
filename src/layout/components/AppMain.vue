              ...
              <div class="wh-reminder-body-layout">
                ...
                <div class="wh-reminder-panel">
                  <template v-if="messageReminderCategory === 'warehouse'">
                    ...
                    <div
                      v-show="showWarehouseApplyBlock"
                      v-loading="warehouseReminderLoading"
                      class="wh-reminder-panel-inner"
                    >
                      <p class="wh-reminder-line">
                        <span class="wh-reminder-label">科室待审核申领单：</span>
                        <span class="wh-reminder-value">{{ warehouseReminder.apply }} 单</span>
                      </p>
                    </div>
                    <div
                      v-show="showWarehousePurchaseBlock"
                      v-loading="warehouseReminderLoading"
                      class="wh-reminder-panel-inner"
                    >
                      <p class="wh-reminder-line">
                        <span class="wh-reminder-label">科室待审核申购单：</span>
                        <span class="wh-reminder-value">{{ warehouseReminder.purchase }} 单</span>
                      </p>
                    </div>
                    <div
                    ...
                    <p v-if="warehouseReminderError && showWarehouseBillBlock" class="wh-reminder-error">{{ warehouseReminderError }}</p>
                  </template>
...
import { fetchHomeWarehouseReminderCounts } from '@/api/dashboard/home'
